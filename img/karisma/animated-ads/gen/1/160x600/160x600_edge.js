   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid358", tween: [ "style", "${_save45text5}", "opacity", '1', { fromValue: '0'}], position: 16740, duration: 760, easing: "easeOutQuad" },
            { id: "eid317", tween: [ "style", "${_image-3a}", "top", '0px', { fromValue: '110px'}], position: 11883, duration: 0, easing: "easeOutQuad" },
            { id: "eid354", tween: [ "style", "${_image-2a}", "opacity", '0.99', { fromValue: '1'}], position: 0, duration: 11654, easing: "easeOutQuad" },
            { id: "eid355", tween: [ "style", "${_image-2a}", "opacity", '0', { fromValue: '0.9900000095367432'}], position: 11654, duration: 425, easing: "easeOutQuad" },
            ...
            { id: "eid214", tween: [ "style", "${_gen_text}", "opacity", '1', { fromValue: '0.000000'}], position: 8579, duration: 812, easing: "easeInQuad" },
            { id: "eid215", tween: [ "style", "${_gen_text}", "opacity", '0.99', { fromValue: '1'}], position: 9391, duration: 1938, easing: "easeInQuad" },
            { id: "eid216", tween: [ "style", "${_gen_text}", "opacity", '0', { fromValue: '0.990000'}], position: 11329, duration: 750, easing: "easeInQuad" },
            ...
            { id: "eid356", tween: [ "style", "${_image-2a}", "left", '0px', { fromValue: '160px'}], position: 6555, duration: 2029, easing: "easeOutQuad" },
            ...
            { id: "eid312", tween: [ "style", "${_image-2b}", "top", '0px', { fromValue: '0px'}], position: 7253, duration: 0, easing: "easeOutQuad" },
            { id: "eid188", tween: [ "style", "${_rethink3}", "top", '0px', { fromValue: '0px'}], position: 0, duration: 0, easing: "easeOutQuad" },
            { id: "eid313", tween: [ "style", "${_image-2b}", "left", '0px', { fromValue: '160px'}], position: 7253, duration: 1773, easing: "easeOutQuad" },
            ...
            { id: "eid353", tween: [ "style", "${_image-2a}", "top", '0px', { fromValue: '0px'}], position: 6555, duration: 0, easing: "easeOutQuad" },
            ...
            { id: "eid336", tween: [ "style", "${_logo2}", "left", '0px', { fromValue: '-1px'}], position: 12363, duration: 1163 },
            { id: "eid270", tween: [ "style", "${_book_now_btn4}", "opacity", '1', { fromValue: '0'}], position: 15990, duration: 750, easing: "easeOutQuad" },
            { id: "eid335", tween: [ "style", "${_logo2}", "opacity", '1', { fromValue: '0'}], position: 12363, duration: 1163 },
            ...
            { id: "eid314", tween: [ "style", "${_image-2b}", "opacity", '0.99', { fromValue: '1'}], position: 1526, duration: 10182, easing: "easeOutQuad" },
            { id: "eid315", tween: [ "style", "${_image-2b}", "opacity", '0', { fromValue: '0.9900000095367432'}], position: 11708, duration: 371, easing: "easeOutQuad" },
            ...
            { id: "eid331", tween: [ "style", "${_logo2}", "top", '531px', { fromValue: '562px'}], position: 12363, duration: 0 },
            { id: "eid324", tween: [ "style", "${_image-3b}", "top", '5px', { fromValue: '124px'}], position: 10357, duration: 0, easing: "easeOutQuad" },
            { id: "eid325", tween: [ "style", "${_image-3b}", "top", '5px', { fromValue: '5px'}], position: 13001, duration: 0, easing: "easeOutQuad" },
            { id: "eid323", tween: [ "style", "${_image-3b}", "left", '160px', { fromValue: '230px'}], position: 10357, duration: 0, easing: "easeOutQuad" },
            { id: "eid327", tween: [ "style", "${_image-3b}", "left", '0px', { fromValue: '160px'}], position: 13001, duration: 1525, easing: "easeOutQuad" },
            { id: "eid294", tween: [ "style", "${_image-1b2}", "left", '160px', { fromValue: '160px'}], position: 0, duration: 0, easing: "easeOutQuad" },
            { id: "eid298", tween: [ "style", "${_image-1b2}", "left", '0px', { fromValue: '160px'}], position: 1000, duration: 1250, easing: "easeOutCubic" },
            { id: "eid321", tween: [ "style", "${_image-3a}", "left", '0px', { fromValue: '159px'}], position: 11883, duration: 1643, easing: "easeOutQuad" },
            { id: "eid349", tween: [ "style", "${_image-1c}", "top", '0px', { fromValue: '0px'}], position: 0, duration: 0 },
            { id: "eid239", tween: [ "style", "${_gi_text2}", "opacity", '1', { fromValue: '0.000000'}], position: 14299, duration: 2201, easing: "easeOutQuad" }         ]
      }
   }
},
"book_now_btn": {
