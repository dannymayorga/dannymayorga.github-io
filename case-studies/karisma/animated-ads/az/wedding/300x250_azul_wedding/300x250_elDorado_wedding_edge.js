   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid44", tween: [ "style", "${_love}", "top", '23px', { fromValue: '23px'}], position: 10050, duration: 0 },
            { id: "eid58", tween: [ "style", "${_book-btn}", "top", '56px', { fromValue: '57px'}], position: 10050, duration: 115 },
            { id: "eid13", tween: [ "transform", "${_image-2}", "scaleY", '1.2', { fromValue: '1'}], position: 4598, duration: 6800 },
            ...
            { id: "eid1", tween: [ "style", "${_love}", "opacity", '1', { fromValue: '0'}], position: 430, duration: 1273 },
            { id: "eid2", tween: [ "style", "${_love}", "opacity", '0', { fromValue: '1'}], position: 4214, duration: 916 },
            ...
            { id: "eid11", tween: [ "style", "${_image-2}", "opacity", '1', { fromValue: '0'}], position: 4598, duration: 891 },
            ...
            { id: "eid10", tween: [ "transform", "${_image-2}", "scaleX", '1.2', { fromValue: '1'}], position: 4598, duration: 6800 },
